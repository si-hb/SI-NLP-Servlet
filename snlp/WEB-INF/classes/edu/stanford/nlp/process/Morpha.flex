...
<verb,noun,any>{GM}*"-"   { return common_noun_stem().concat(next()); } // what does this do and what to do with this?  Means it isn't stemmed separately, but second half can be
