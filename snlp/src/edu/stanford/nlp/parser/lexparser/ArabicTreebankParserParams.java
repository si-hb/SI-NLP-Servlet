...
public class ArabicTreebankParserParams extends AbstractTreebankParserParams {
  ...
  private void initializeAnnotationPatterns() {
    ...
    try {
      ...
      annotationPatterns.put("-markMasdarVP", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@VP|MWV < /VBG|VN/"), new SimpleStringFunction("-masdar")));
      annotationPatterns.put("-containsSVO", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("__ << (@S < (@NP . @VP|MWV))"), new SimpleStringFunction("-hasSVO")));
