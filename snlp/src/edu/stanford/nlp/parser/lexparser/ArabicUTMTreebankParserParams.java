 ...
 * @author Spence Green
 */
public class ArabicUTMTreebankParserParams extends AbstractTreebankParserParams {
  ...
  public ArabicUTMTreebankParserParams() {
    super(new ArabicUTMTreebankLanguagePack());

    optionsString = new StringBuilder();
    optionsString.append("ArabicUTMTreebankParserParams\n");
  ...
  public HeadFinder headFinder() {
    if(headFinder == null)
      headFinder = new ArabicUTMHeadFinder(treebankLanguagePack());
    return headFinder;
  }
...
//    baselineFeatures.add("-markMasdarVP");
  ...
  private void initializeAnnotationPatterns() {
    ...
    final String genitiveNodeTregexString = "@NP|MWNP > @NP|MWNP $- /^N/";
    ...
    try {
      ...
      annotationPatterns.put("-markStrictBaseNP",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@NP|MWNP !< (__ < (__ < __))"),new SimpleStringFunction("-base"))); // NP with no phrasal node in it
      annotationPatterns.put("-markOneLevelIdafa",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@NP|MWNP < (@NP|MWNP < (__ < __)) !< (/^[^N]/ < (__ < __)) !< (__ < (__ < (__ < __)))"),new SimpleStringFunction("-idafa1")));
      annotationPatterns.put("-markNounNPargTakers",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@NOUN ># (@NP|MWNP < @NP|MWNP)"),new SimpleStringFunction("-NounNParg")));
      ...
      annotationPatterns.put("-splitIN",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@ADP < __=word"), new AddRelativeNodeFunction("-","word", false)));
      ...
      annotationPatterns.put("-containsSVO", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("__ << (@S < (@NP|MWNP . @VP))"), new SimpleStringFunction("-hasSVO")));
      annotationPatterns.put("-splitCC",new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("@CONJ . __=term , __"),new AddEquivalencedConjNode("-","term")));
      ...
      // Extra MWE features for CL submission
      ...
      annotationPatterns.put("-tagPA", new Pair<TregexPattern,Function<TregexMatcher,String>>(tregexPatternCompiler.compile("!@PUNC < (__ !< __) > __=parent"),new AddRelativeNodeFunction("-","parent", true)));
  ...
  private static class AddRelativeNodeFunction implements SerializableFunction<TregexMatcher,String> {
    ...
    private static final TreebankLanguagePack tlp = new ArabicUTMTreebankLanguagePack();
  ...
  public void display(PrintWriter pw) {
    pw.println(optionsString.toString());
  }
  ...
  public int setOptionFlag(String[] args, int i) {
    ...
    //        ((ArabicUTMTreebankLanguagepack) treebankLanguagePack()).setTokenizerFactory(aTF);
