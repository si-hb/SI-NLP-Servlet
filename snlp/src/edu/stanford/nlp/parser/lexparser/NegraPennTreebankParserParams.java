...
public class NegraPennTreebankParserParams extends AbstractTreebankParserParams {
 ...
 // override output encoding: make it UTF-8
  ...
  public void display(PrintWriter pw) {
	pw.println("NegraPennTreebankParserParams");
	pw.println("  markZuVP=" + markZuVP);
	pw.println("  insertNPinPP=" + treeNormalizerInsertNPinPP);
	pw.println("  leaveGF=" + treeNormalizerLeaveGF);
	pw.println("markLP=" + markLP);
	pw.println("markColon=" + markColon);
  }
